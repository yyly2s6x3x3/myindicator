...
public class ViewPagerIndicator extends LinearLayout
{
	...
	public void setTabItemTitles(List<String> datas,int textcolornormal,int textselect,Type type)
	{
		// 如果传入的list有值，则移除布局文件中设置的view
		if (datas != null && datas.size() > 0)
		{
			this.COLOR_TEXT_NORMAL=textcolornormal;
			this.COLOR_TEXT_HIGHLIGHTCOLOR=textselect;
			this.type=type;
	...
	public void scroll(int position, float offset)
	{
		...
		if (offset > 0 && position >= (mTabVisibleCount - 2)&&position<mTabTitles.size()-2
